...
export function AddShareDialog({ open, onClose, device, onCreated, editingShare }: AddShareDialogProps) {
  ...
  const validateCronExpression = (value: string) => {
    ...
    const hours = /^([01]?\d|2[0-3]|\*|\*\/[1-9]\d*|[01]?\d\/[1-9]\d*|[01]?\d-2[0-3]|([01]?\d,)+2[0-3])$/;
    const dayOfMonth = /^([1-9]|[12]\d|3[01]|\*|\?|L|LW|L-[1-9]|[1-9]W|[12]\dW|3[01]W|([1-9]|[12]\d|3[01])-[1-9]|([1-9]|[12]\d|3[01])\/[1-9]\d*|([1-9]|[12]\d|3[01])(,([1-9]|[12]\d|3[01]))+)$/;
    const month = /^(1[0-2]|0?[1-9]|JAN|FEB|MAR|APR|MAY|JUN|JUL|AUG|SEP|OCT|NOV|DEC|\*|\*\/[1-9]\d*|(1[0-2]|0?[1-9])-[1-9]|(1[0-2]|0?[1-9])\/[1-9]\d*|(1[0-2]|0?[1-9])(,(1[0-2]|0?[1-9]))+)$/i;
